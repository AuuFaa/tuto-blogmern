...
export default function Header() {
  ...
  return (
    ...
    <header className="container mx-auto px-5 py-3 ">
      ...
      <div className={`${navIsVisible ? "right-0" : "-right-full"} transition-all duration-300 mt-[100px] lg:mt-0 bg-dark-hard lg:bg-transparent z-[49] flex flex-col w-full lg:w-auto justify-center lg:justify-end lg:flex-row fixed top-0 bottom-0 lg:static gap-5 items-center `} >
